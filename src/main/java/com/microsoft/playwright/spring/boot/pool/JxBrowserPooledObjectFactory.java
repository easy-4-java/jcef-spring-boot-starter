...
@Slf4j
public class JxBrowserPooledObjectFactory implements PooledObjectFactory<BrowserContext>, AutoCloseable {
    ...
    public JxBrowserPooledObjectFactory(PlaywrightProperties playwrightProperties) {
