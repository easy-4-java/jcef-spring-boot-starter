...
**jcef-spring-boot-starter** is a Spring Boot starter that integrates **jcef** for applications using jcef. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume jcef capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using jcef |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for jcef |
| JDK | `17` |
| Coordinates | `io.github.easy4j:jcef-spring-boot-starter:1.0.x.20260630-SNAPSHOT` |
| Config Prefix | `jcef` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers jcef beans automatically |
| Property Binding | ✅ Stable | Binds `jcef.*` to `Properties` |
